...
For this matter, it was needed to create specific tests to check this special
moves.  For example, at 5 ply, there can't be a game with a promoted pawn case,
...
\begin{figure}[H]
    ...
    \caption{The left-most screenshot is the result of the test, and others 
        are a sequence of screenshots of the user doing the promotion
    manually, and playing a move after to check if the piece is responsive.}
\end{figure}
