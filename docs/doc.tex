...
You can enter directly the CLI interface by running: $\$~python3~mychess.main~-cli$.
...
$\$~python3~mychess.main~-gui$. There is no time control, just dragging and dropping
