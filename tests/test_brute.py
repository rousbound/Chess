...
# Position 1
# test_position(1, [48, 2_039, 97_862, 4_085_603], FEN = "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0")

# Position 2
# test_position(1, [14, 191, 2_812, 43_238], FEN = "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0")

# Position 3
test_position(4, [6, 264 , 9_467, 422_333], FEN = "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1")

# Position 4
# test_position(1, [44, 1_486 , 62_379, 2_103_487], FEN = "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8")

# Position 5
# test_position(1, [46 , 2_079, 89_890], FEN = "r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10")
